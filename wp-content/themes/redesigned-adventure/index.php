...
<main class="main" role="main">
  ...
  <section class="section u-b-grey" id="a-propos">
    <div class="container">
      <h2 class="section__title heading-1">A propos</h2>
      <div class="row">
        <div class="section__left column is-one-third-desktop">
          <p class="section__teasing teasing-1 rte">Cat ipsum dolor sit amet, <a href="#">howl uncontrollably</a> for no reason. Roll on the floor purring your whiskers off toy mouse squeak roll over yet climb leg</p>
        </div>
        <div class="section__right column is-two-third">
          ...
          <button class="btn">Voir mon CV</button>
        </div>
      </div>
    </div>
  </section>
